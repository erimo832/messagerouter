...
; var chartManager = (function ($) {
    ...
    obj.init = function (chartElementName, chartContainerElementName, statusElementName, dataManager, connectionManager, settings, getConfigFunction) {
        ...
        //init data manager
        dataManager.init(settings.dataSettings.dataMaxNumberOfDataPoints, settings.dataSettings.dataSaveWindowSeconds, settings.dataSettings.timeStampColumn, settings.dataSettings.valueColumn, settings.dataSettings.isCompleteDatasetReceived, settings.dataSettings.dataListProperty);
